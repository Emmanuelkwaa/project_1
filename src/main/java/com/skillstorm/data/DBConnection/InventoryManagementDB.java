package com.skillstorm.data.DBConnection;
...
public class InventoryManagementDB {
    ...
    private InventoryManagementDB() {
        try {
            ...
            try (InputStream input = InventoryManagementDB.class.getClassLoader()
    ...
    public static InventoryManagementDB getInstance() {
        if (instance == null) { // Lazily initialize a connection to the DB
            instance = new InventoryManagementDB();
        }
        return instance;
    }
